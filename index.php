...
if ($fsc->template) {
    ...
    if (is_writable('tmp')) {
        ...
        . '<p>Consulta la <a target="_blank" href="//help.soft.finance/carpeta_temporal">documentaci&oacute;n</a>.</p>'
        . '</center>';
        die('<center><iframe src="//help.soft.finance/carpeta_temporal" width="90%" height="800"></iframe></center>');
    }
