...
function guarda_config(&$errors, $nombre_archivo)
{
    ...
    if ($archivo) {
        ...
        fwrite($archivo, "define('FS_SKIN', 'skin-blue');\n");
...
$system_info = 'Adding.tech: ' . file_get_contents('VERSION') . "\n";
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="es" xml:lang="es" >
    ...
    <body>
        <nav class="navbar navbar-default" role="navigation" style="margin: 0px;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php">Adding.tech</a>
                </div>
        ...
        <form name="f_feedback" action="https://help.soft.finance/feedback" method="post" target="_blank" class="form" role="form">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <p class="help-block">
                                ...
                                Para facilitarnos el trabajo este formulario también nos informa de la versión del
                                software que usas, versión de php, etc...
                            </p>
                        </div>
        ...
        <div class="container">
                ...
                <div class="col-sm-12">
                    <div class="page-header">
                        <h1>
                            ...
                            Bienvenido al instalador de Adding.tech
                    ...
                    foreach ($errors as $err) {
                        if ($err == 'permisos') {
                            ...
                            <div class="panel panel-danger">
                                ...
                                <div class="panel-body">
                                    <p>
                                        Adding.tech necesita la extensión mbstring para poder trabajar con caracteres
                            ...
                            <div class="panel panel-danger">
                                ...
                                <div class="panel-body">
                                    <p>
                                        Adding.tech necesita la extensión OpenSSL para poder descargar plugins,
                                    ...
                                    <p class="help-block">
                                        Ofrecemos una versión de Adding.tech para Windows <b>con todo</b> el software necesario
                                        (como OpenSSL) ya incluido de serie. 
                                    </p>
                                    <h3>
                                        <i class="fa fa-linux" aria-hidden="true"></i> Linux
                                    </h3>
            ...
            <div class="row" style="margin-bottom: 20px;">
                <div class="col-sm-12 text-center">
                    <hr/>
                    <small>&COPY; 2013-2017 Motor del software:FacturaScripts</small>
                </div>
            </div>
        </div>
    </body>
